...
Выводя элементы первой (нулевой строчки), мы доходим до последнего с индексом [0][m-1]. Далее мы должны сдвинуться на строчку вниз. Флажком для сдвига будет дошедшее до m значение счетчика counter и m0. Мы уменьшаем m0 на один, чтобы не выйти за границы массива, и увеличиваем n0 на 1. 
Похожим образом мы доходим до первого элемента второй (первой) строчки с индексом [1][0]. Далее мы должны сдвинуться на строчку вниз. Флажком для сдвига будет дошедшее до 0 значение счетчика counter. Мы увеличиваем m0 на один, чтобы не выйти за границы массива, и увеличиваем n0 на 1. 
Так мы доходим до конца массива.
